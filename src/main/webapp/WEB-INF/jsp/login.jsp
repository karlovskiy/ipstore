...
<style type="text/css">
 ...
 <body>
    ...
    <div class="alert alert-error">
        <a class="errorblock" data-dismiss="alert"> ${sessionScope["SPRING_SECURITY_LAST_EXCEPTION"].message} </a>
    </div>
</c:if>
        ...
        <button name="submit" type="submit" class="btn btn-large btn-primary" > Sign in</button>
      </form>
