    ...
    <div id="view-buttons">
        <div class="row">
            <div class="span1 ml-15px">
                <a class="btn btn-primary btn-block" href="<c:url value="/equipment"/>">List</a>
            </div>
            <security:authorize access="hasRole('ROLE_EQUIPMENT_EDIT')">
                <div class="span1 ml-10px">
                    <a class="btn btn-primary btn-block" href="<c:url value="/equipment/edit/${equipment.id}" />">Edit</a>
                </div>
