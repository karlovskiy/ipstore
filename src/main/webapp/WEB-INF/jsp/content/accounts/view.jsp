...
<div class="container">
    <div id="view-fields">
        <div class="row">
            ...
            <div class="span5"><c:out value="${account.login}"/></div>
        </div>
        <div class="row">
            <div class="span1">Password</div>
            <div class="span5"><c:out value="${account.password}"/></div>
        </div>
        <div class="row">
            <div class="span1">ClientName</div>
            <div class="span5"><c:out value="${account.clientName}"/></div>
        </div>
        <div class="row">
            <div class="span1">Number</div>
            <div class="span5"><c:out value="${account.number}"/></div>
        </div>
        <div class="row">
            <div class="span1">Description</div>
            <div class="span5"><c:out value="${account.description}"/></div>
        </div>
        <div class="row">
            <div class="span1">Status</div>
            <div class="span5">
                <span class="${account.status}"><c:out value="${account.status}"/></span>
            </div>
        </div>
    </div>
