...
import static ipstore.Utils.DATE_TIME_WITH_SECONDS;
...
public class ActionWithUpdateChangesObserver extends BaseObserver {
    ...
    public ActionWithUpdateChangesObserver(ipstore.aspect.Action action, ActionService actionService, ProceedingJoinPoint pjp) {
        super(action.value());
